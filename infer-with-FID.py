...
from one_model_LN_swin_v5 import SelfInpaint  # SelfInpaint 모델 사용
import lpips
...
model = SelfInpaint(
    ...
    dropout=0.5,
    mask_predictor_mid_channels=32  # 마스크 예측기의 중간 채널 수 (필요에 따라 조절)
).to(device)

# 가중치 로드
model_path = "/home/prml/YY/2503_miccai/fed_inpaint/Cen_WavePaint_onemodel_LN_swin_B4.pth"
...
# 출력 폴더 설정
output_dir = "Cen_WavePaint_onemodel/test_generated"
damaged_dir = "Cen_WavePaint_onemodel/test_damaged"
